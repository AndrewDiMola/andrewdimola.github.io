...
Here's an example of what I'm building towards using my super-awesome MS Paint skills sprites and some borrowed from Final Fantasy I (Square Enix Co., Ltd.). Note: these sprites will not be used in the final product, and are only used for demonstration purposes.
